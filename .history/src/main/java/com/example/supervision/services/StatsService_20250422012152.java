...
public Map<String, Object> getFormateurStats(Long formateurId) {
    ...
    Formateur formateur = formateurRepository.findById(formateurId)
        ...
        LocalDate dateInscription = formateur.getDateInscription().toInstant()
        .atZone(ZoneId.systemDefault())
        .toLocalDate();
    // Données de base
    stats.put("name", formateur.getNom() + " " + formateur.getPrenom());
    stats.put("email", formateur.getEmail());
    String dateIntegration = "Non disponible";
    if (formateur.getDateInscription() != null) {
        dateIntegration = formateur.getDateInscription().toInstant()
            .atZone(ZoneId.systemDefault())
            .toLocalDate()
            .format(DateTimeFormatter.ofPattern("dd/MM/yyyy"));
    }
    stats.put("dateIntegration", dateIntegration);
