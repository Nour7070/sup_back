...
public class ActivityLogService {
    ...
    public void log(String type, String description, Long formateurId, Long moderatorId, String moderatorName) {
        ActivityLog activity = new ActivityLog();
        activity.setType(type);
        activity.setDescription(description);
        activity.setTimestamp(LocalDateTime.now());
        activity.setFormateurId(formateurId);
        activity.setModeratorId(moderatorId);
        activity.setModeratorName(moderatorName);
        repository.save(activity);
    }
