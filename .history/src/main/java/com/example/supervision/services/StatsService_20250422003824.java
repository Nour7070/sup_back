...
public class StatsService {
    ...
    stats.put("photo", formateur.getPhotoUrl());
    stats.put("age", calculateAge(formateur.getDateNaissance()));
...
public Map<String, Object> getApprenantStats(Long apprenantId) {
    ...
    stats.put("photo", apprenant.getPhotoUrl());
    stats.put("age", calculateAge(apprenant.getDateNaissance()));
