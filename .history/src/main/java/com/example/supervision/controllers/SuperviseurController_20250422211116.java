...
public ResponseEntity<List<Cours>> getPendingCourses() {
  ...
  // Hedou endpoints temporaires
  @PostMapping("/simulation-formateur") 
  public ResponseEntity<Formateur> simulFormateur(@RequestBody Formateur formateur) {
      Formateur savedFormateur = superviseurService.simulFormateur(formateur);
