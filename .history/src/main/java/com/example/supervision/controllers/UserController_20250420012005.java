...
public ResponseEntity<FormateurStats> getFormateurStats(@PathVariable Long id) {
    ...
    FormateurStats stats = new FormateurStats();
    ...
    stats.setQuizzesCrees(courseService.countQuizzesByFormateur(id));
