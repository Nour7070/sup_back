...
public class KafkaProducerService {
    ...
    public void sendFormateurStatus(String email, String status) {
     ...
     public void sendFormateurPending(Moderateur moderateur) {
        ...
        moderateurData.put("prenom", moderateur.getFirstName());
        moderateurData.put("nom", moderateur.getLastName());
        moderateurData.put("username", formateur.getUsername());
        moderateurData.put("status", formateur.getStatus().name());
        moderateurData.put("certificats", formateur.getCertificats());
        moderateurData.put("experiences", formateur.getExperiences());
