...
public void handleFormateurPending(String jsonPayload) {
    try {
        ...
        String id = (Long) formateurData.get("id");
...
public void handleChapterCreated(String message) {
    try {
        ...
        String description = String.format("Course with chapter %s created and pending approval .", chapter.getTitle());
            activityLogService.log(
