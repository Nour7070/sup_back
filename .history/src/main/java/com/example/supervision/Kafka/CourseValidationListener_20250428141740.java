...
public class CourseValidationListener {
    ...
    public void handleCourseValidation(Map<String, Object> courseData) {
        try {
            log.info("Données de cours reçues pour validation: {}", courseData);
            ...
            courseRepository.flush();
            log.info("Cours {} sauvegardé avec succès en attente de validation", savedCours.getId());
