...
public class KafkaConsumerService {
    ...
    public void handleFormateurPending(Map<String, Object> formateurData) {
        try {
            ...
            formateur.setCertificats(certificats);
            formateur.setExperiences(experiences);
            
            formateurRepository.save(formateur);
            System.out.println("Formateur en attente sauvegardé avec succès: " + email);
            
           //hna nzid le truc te3 activities
            
        } catch (Exception e) {
            System.out.println("Erreur lors du traitement du formateur en attente: " + e.getMessage()+ e);
        }
    }
