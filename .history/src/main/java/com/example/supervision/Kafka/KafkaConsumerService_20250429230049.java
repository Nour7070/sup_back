...
public void handleCourseCreated(String message) {
    try {
        ...
        Long formateurId = ((Number) data.get("formateurId")).longValue(); // Récupération de l'ID
        ...
        if (langueStr != null) {
            try {
                ...
                logger.warn("Langue invalide: {}, défaut FRENCH utilisé", langueStr);
            }
        }
        ...
        cours.setFormateurId(formateurId); // Assignation directe de l'ID
        
        coursRepository.save(cours);
        
    } catch (Exception e) {
        logger.error("Erreur lors du traitement du cours", e);
