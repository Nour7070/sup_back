...
public class KafkaConsumerService {
    ...
    public void receiveUserData(ConsumerRecord<String, Map<String, String>> record) {
        Map<String, String> userData = record.value();
        ...
        // Création d'un nouvel utilisateur avec les données Kafka
        User newUser = new User();
        newUser.setUsername(userData.get("username"));
        newUser.setEmail(email);
        newUser.setPhoto(userData.get("photo"));
        newUser.setUserType(newUserType); // Assigne la valeur reçue
