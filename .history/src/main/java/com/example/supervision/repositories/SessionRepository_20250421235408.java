...
public interface SessionRepository extends JpaRepository<Session, Long> {
    ...
    @Query("SELECT SUM(TIMESTAMPDIFF(SECOND, s.startTime, s.endTime)) FROM Session s WHERE s.apprenantId = :apprenantId")
    Long getTotalTimeSpent(@Param("apprenantId") Long apprenantId);
}