...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    long countBySubscribedFormateurId(Long formateurId);
    
    @Query("SELECT COUNT(u) FROM User u WHERE u.userType = 'APPRENANT' AND :formateurId MEMBER OF u.formateursSuivis")
    long countStudentsSubscribedToFormateur(@Param("formateurId") Long formateurId);
