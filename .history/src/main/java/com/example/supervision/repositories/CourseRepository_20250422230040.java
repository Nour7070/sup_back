...
public interface CourseRepository extends JpaRepository<Cours, UUID> {
    ...
    /*@Query("SELECT c.domaine as domaine, COUNT(c) as count FROM Cours c WHERE c.formateurId = :formateurId GROUP BY c.domaine")
    List<Map<String, Object>> countByCategorie(@Param("formateurId") Long formateurId);*/
